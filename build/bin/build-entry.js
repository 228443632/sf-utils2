...
const MAIN_TEMPLATE = `/* Author：bianpengfei Automatically generated by './bin/build-entry.js' */
...
FILE_PATHS.forEach(v => {
  ...
  if (dirs.length != [...new Set([...dirs, ...EXCLUDE_DIRS])].length && !EXCLUDE_FILES.includes(moduleName)) {
    importTemplate.push(
