...
```js
const { readDirStructureSync } = require('@bianpengfei/utils/lib/nodejs')
const fs = require('fs')
...
| ---- | -------- |-----------| -------- | ------ |
| path  | 绝对路径 | `String`  | 是       | ------ |
| parentPath  | 父目录 绝对路径 | `String`  | 是       | ------ |
| ext  | 拓展名 | `String`  | 是       | ------ |
| dir  | 目录地址 | `String`  | 是       | ------ |
| type  | 类型 `file` 或 `dir` | `String`  | 是       | ------ |
| relativePath  | 相对路径 | `String`  | 是       | ------ |
| rootDir  | 根路径 | `String` | 是       | ------ |
| isRoot  | 是否根路径文件夹 | `Boolean` | 是       | ------ |
