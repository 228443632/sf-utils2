...
<Badge text="v3.0.10+" type="success" vertical="middle"/>
:::
...
<template>
  <div>
    <div class="flex justify-center">
      <label>
        <span>输入label名：</span>
        <input v-model="input" class="border-[#8c8c8c] border-1px px-8px rounded-4px" placeholder="过滤label名" />
      </label>
      <label class="ml-20px">
        <span>保留子孙节点：</span>
        <input
    ...
    <br />
    <div class="overflow-y-auto h-400px !bg-[transparent] border-1px border-[#eee] rounded-sm !px-12px">
...
<script>
import { filterTree } from 'sf-utils2'
