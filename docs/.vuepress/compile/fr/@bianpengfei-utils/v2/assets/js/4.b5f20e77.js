    ...
    798: function (t, e, r) {
      ...
      r.r(e),
        function (t) {
          ...
          var i = r(799),
            n = r.n(i),
            s = (r(177), r(73), r(182), r(102), r(46), r(800)),
            a = r.n(s),
            o = (r(101), r(364), r(99), r(801)),
            h = r.n(o),
            u = (r(238), r(803)),
            l = r.n(u),
            c = (r(126), r(179), r(180), r(804)),
            g = (r(127), r(805))
          var d = Object.freeze({
            __proto__: null,
            offscreen: function () {
              var { DOMParser: t } = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                e = {
                  window: null,
                  ignoreAnimation: !0,
                  ignoreMouse: !0,
          ...
          var v = /^[A-Z-]+$/
          function x(t) {
            return v.test(t) ? t.toLowerCase() : t
          }
          function b(t) {
            var e = /url\(('([^']+)'|"([^"]+)"|([^'")]+))\)/.exec(t) || []
            return e[2] || e[3] || e[4]
          ...
          class U {
            ...
            getColor(t) {
              ...
              return this.isNormalizedColor || ((this.isNormalizedColor = !0), (e = S(e)), (this.value = e)), e
            }
            getDpi() {
              return 96
            }
            ...
            getTextBaseline() {
              return this.hasValue() ? U.textBaselineMapping[this.getString()] : null
            }
            addOpacity(t) {
              ...
              return new U(this.document, this.name, e)
            }
          }
          U.textBaselineMapping = {
            baseline: 'alphabetic',
            'before-edge': 'top',
          ...
          class Y {
            ...
            static parsePath(t) {
              for (var e = m(t), r = e.length, i = [], n = 0; n < r; n += 2) i.push(new Y(e[n], e[n + 1]))
              return i
            }
            angleTo(t) {
          ...
          class j {
            ...
            mapXY(t, e) {
              for (var { window: r, ctx: i } = this.screen, n = new Y(t, e), s = i.canvas; s; )
          ...
          var q = 'undefined' != typeof window ? window : null,
            Q = 'undefined' != typeof fetch ? fetch.bind(void 0) : null
          class W {
            constructor(t) {
              var { fetch: e = Q, window: r = q } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
              ;(this.ctx = t),
                (this.FRAMERATE = 30),
            ...
            setViewBox(t) {
              var {
                ...
                C = s,
                P = o
              'meet' === b && ((C *= T), (P *= T)), 'slice' === b && ((C *= A), (P *= A))
              var O = new U(e, 'refX', l),
                E = new U(e, 'refY', c),
                M = O.hasValue() && E.hasValue()
              if ((M && r.translate(-T * O.getPixels('x'), -T * E.getPixels('y')), g)) {
                var N = T * d,
                  V = T * p
                r.beginPath(), r.moveTo(N, V), r.lineTo(n, V), r.lineTo(n, a), r.lineTo(N, a), r.closePath(), r.clip()
              }
              if (!M) {
                var _ = 'meet' === b && T === w,
                  k = 'slice' === b && A === w,
                  R = 'meet' === b && T === S,
                  I = 'slice' === b && A === S
                x.startsWith('xMid') && (_ || k) && r.translate(n / 2 - C / 2, 0),
                  x.endsWith('YMid') && (R || I) && r.translate(0, a / 2 - P / 2),
                  x.startsWith('xMax') && (_ || k) && r.translate(n - C, 0),
                  x.endsWith('YMax') && (R || I) && r.translate(0, a - P)
              }
              switch (!0) {
                case 'none' === x:
                  r.scale(S, w)
                ...
                var p = Date.now(),
                  ...
                  v = () => {
                    ;(p = Date.now()),
                      (m = p - y) >= f &&
                        ((y = p - (m % f)),
                        this.shouldUpdate(i, a) && (this.render(t, n, s, o, u, l, c), d.runEvents())),
                      (this.intervalId = h()(v))
                  }
                r || d.start(), (this.intervalId = h()(v))
              }
            }
            stop() {
              this.intervalId && (h.a.cancel(this.intervalId), (this.intervalId = null)), this.mouse.stop()
            }
            shouldUpdate(t, e) {
              if (!t) {
              ...
              return (
                !('function' != typeof e || !e()) || !(this.isReadyLock || !this.isReady()) || !!this.mouse.hasEvents()
              )
            }
            render(t, e, r, i, n, s, a) {
              ...
              !e &&
                ...
                (d.hasValue() && ((g.width = d.getPixels('x')), g.style && (g.style.width = ''.concat(g.width, 'px'))),
                f.hasValue() &&
                  ((g.height = f.getPixels('y')), g.style && (g.style.height = ''.concat(g.height, 'px'))))
              var p = g.clientWidth || g.width,
                y = g.clientHeight || g.height
              if (
                (e && d.hasValue() && f.hasValue() && ((p = d.getPixels('x')), (y = f.getPixels('y'))),
                u.setCurrent(p, y),
                ...
                var v = m(t.getAttribute('viewBox').getString()),
                  x = 0,
                  b = 0
                if ('number' == typeof i) {
                  var S = t.getStyle('width')
                  S.hasValue() ? (x = S.getPixels('x') / i) : isNaN(v[2]) || (x = v[2] / i)
                }
                if ('number' == typeof n) {
                  var w = t.getStyle('height')
                  w.hasValue() ? (b = w.getPixels('y') / n) : isNaN(v[3]) || (b = v[3] / n)
                }
                x || (x = b),
                  b || (b = x),
              ...
              r || l.clearRect(0, 0, p, y), t.render(l), c && (this.isFirstRender = !1)
            }
          }
          ;(W.defaultWindow = q), (W.defaultFetch = Q)
          var { defaultFetch: G } = W,
            $ = 'undefined' != typeof DOMParser ? DOMParser : null
          class Z {
            constructor() {
              var { fetch: t = G, DOMParser: e = $ } =
          ...
          class J {
            constructor(t, e) {
              ;(this.type = 'translate'), (this.point = null), (this.point = Y.parse(e))
            }
            apply(t) {
          ...
          class tt {
            constructor(t, e, r) {
              ...
              var i = Y.parseScale(e)
              ;(0 !== i.x && 0 !== i.y) || ((i.x = V), (i.y = V)),
                (this.scale = i),
                (this.originX = r[0]),
                (this.originY = r[1])
            }
          ...
          class rt extends et {
            constructor(t, e, r) {
              super(t, e, r), (this.type = 'skew'), (this.angle = null), (this.angle = new U(t, 'angle', e))
            }
          }
          class it extends rt {
            constructor(t, e, r) {
          ...
          class st {
            ...
            static fromElement(t, e) {
              var r = e.getStyle('transform', !1, !0),
                ...
                s = [i, n]
              return r.hasValue() ? new st(t, r.getString(), s) : null
            }
            apply(t) {
          ...
          st.transformTypes = { translate: J, rotate: K, scale: tt, matrix: et, skewX: it, skewY: nt }
          class at {
            constructor(t, e) {
              ...
              if (
                ...
                if (
                  (Array.from(e.attributes).forEach(e => {
                    var r = x(e.nodeName)
                    this.attributes[r] = new U(t, r, e.value)
                  }),
            ...
            getStyle(t) {
              ...
              if (e) {
                var o = new U(this.document, t, '')
                return (this.styles[t] = o), o
              }
              return i || U.empty(this.document)
            }
            render(t) {
              if (
            ...
            setContext(t) {}
            applyEffects(t) {
              var e = st.fromElement(this.document, this)
              e && e.apply(t)
            ...
            addChild(t) {
              var e = t instanceof at ? t : this.document.createElement(t)
              ;(e.parent = this), at.ignoreChildTypes.includes(e.type) || this.children.push(e)
            }
            matchesSelector(t) {
              var e,
                { node: r } = this
          ...
          class ct {
            constructor(t, e, r, i, n, s) {
              var a = s ? ('string' == typeof s ? ct.parse(s) : s) : {}
            ...
            static parse() {
              var t = arguments.length > 1 ? arguments[1] : void 0,
                ...
                n = '',
                s = '',
                a = f(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : '')
                  .trim()
                  .split(' '),
              ...
              return (
                a.forEach(t => {
                  switch (!0) {
                    case !o.fontStyle && ct.styles.includes(t):
                      'inherit' !== t && (e = t), (o.fontStyle = !0)
                      break
                    case !o.fontVariant && ct.variants.includes(t):
                      'inherit' !== t && (r = t), (o.fontStyle = !0), (o.fontVariant = !0)
                      break
                    case !o.fontWeight && ct.weights.includes(t):
            ...
            toString() {
              return [
                ...
                lt(this.fontWeight),
                this.fontSize,
                ((e = this.fontFamily), void 0 === t ? e : e.trim().split(',').map(ht).join(','))
              ]
                .join(' ')
                .trim()
              var e
          ...
          ;(ct.styles = 'normal|italic|oblique|inherit'),
            (ct.variants = 'normal|small-caps|inherit'),
            (ct.weights = 'normal|bold|bolder|lighter|100|200|300|400|500|600|700|800|900|inherit')
          class gt {
            constructor() {
            ...
            bezierCurveAdd(t, e, r, i, n) {
              ...
              if (0 !== a) {
                ...
                if (!(h < 0)) {
                  ...
                  0 < u &&
                    u < 1 &&
                    (t ? this.addX(this.sumCubic(u, e, r, i, n)) : this.addY(this.sumCubic(u, e, r, i, n)))
                  var l = (-s - Math.sqrt(h)) / (2 * a)
                  0 < l &&
                    l < 1 &&
                    (t ? this.addX(this.sumCubic(l, e, r, i, n)) : this.addY(this.sumCubic(l, e, r, i, n)))
                }
              } else {
                if (0 === s) return
                var c = -o / s
                0 < c &&
                  c < 1 &&
                  (t ? this.addX(this.sumCubic(c, e, r, i, n)) : this.addY(this.sumCubic(c, e, r, i, n)))
              }
            }
          ...
          class dt extends c.a {
            ...
            getPoint() {
              var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 'x',
                ...
                r = new Y(this.command[t], this.command[e])
            ...
            getReflectedControlPoint() {
              ...
              if (t !== c.a.CURVE_TO && t !== c.a.SMOOTH_CURVE_TO && t !== c.a.QUAD_TO && t !== c.a.SMOOTH_QUAD_TO)
                return this.current
              var {
                current: { x: e, y: r },
                control: { x: i, y: n }
              } = this
              return new Y(2 * e - i, 2 * r - n)
            }
            makeAbsolute(t) {
          ...
          class ft extends at {
            ...
            setContext(t) {
              ...
              if (!e) {
                ...
                if (i.hasValue()) {
                  var h = new U(this.document, 'fill', t.fillStyle).addOpacity(i).getColor()
                  t.fillStyle = h
                }
                ...
                if (s.hasValue()) {
                  var c = new U(this.document, 'stroke', t.strokeStyle).addOpacity(s).getString()
                  t.strokeStyle = c
                }
              ...
              if (((this.modifiedEmSizeStack = !1), void 0 !== t.font)) {
                var w = this.getStyle('font'),
                  ...
                  E = new ct(
                    ...
                    O.getString(),
                    ct.parse(w.getString(), t.font)
                  )
                T.setValue(E.fontStyle),
                  A.setValue(E.fontVariant),
                  C.setValue(E.fontWeight),
                  P.setValue(E.fontSize),
                  O.setValue(E.fontFamily),
                  (t.font = E.toString()),
                  P.isPixels() && ((this.document.emSize = P.getPixels()), (this.modifiedEmSizeStack = !0))
              }
          ...
          class pt extends ft {
            constructor(t, e, r) {
              super(t, e, r),
                ...
                (this.pathParser = new dt(this.getAttribute('d').getString()))
            }
            path(t) {
              ...
              for (e.reset(), t && t.beginPath(); !e.isEnd(); )
                switch (e.next().type) {
                  ...
                  case dt.LINE_TO:
                    this.pathL(t, r)
                    break
                  case dt.HORIZ_LINE_TO:
                    this.pathH(t, r)
                    break
                  case dt.VERT_LINE_TO:
                    this.pathV(t, r)
                    break
                  case dt.CURVE_TO:
                    this.pathC(t, r)
                    break
                  case dt.SMOOTH_CURVE_TO:
                    this.pathS(t, r)
                    break
                  case dt.QUAD_TO:
                    this.pathQ(t, r)
                    break
                  case dt.SMOOTH_QUAD_TO:
                    this.pathT(t, r)
                    break
                  case dt.ARC:
                    this.pathA(t, r)
            ...
            pathL(t, e) {
              var { pathParser: r } = this,
                { current: i, point: n } = pt.pathL(r),
                { x: s, y: a } = n
              r.addMarker(n, i), e.addPoint(s, a), t && t.lineTo(s, a)
            }
            static pathH(t) {
              var { current: e, command: r } = t,
                i = new Y((r.relative ? e.x : 0) + r.x, e.y)
              return (t.current = i), { current: e, point: i }
            }
            pathH(t, e) {
              var { pathParser: r } = this,
                { current: i, point: n } = pt.pathH(r),
                { x: s, y: a } = n
              r.addMarker(n, i), e.addPoint(s, a), t && t.lineTo(s, a)
            }
            static pathV(t) {
              var { current: e, command: r } = t,
                i = new Y(e.x, (r.relative ? e.y : 0) + r.y)
              return (t.current = i), { current: e, point: i }
            }
            pathV(t, e) {
              var { pathParser: r } = this,
                { current: i, point: n } = pt.pathV(r),
                { x: s, y: a } = n
              r.addMarker(n, i), e.addPoint(s, a), t && t.lineTo(s, a)
            }
            static pathC(t) {
            ...
            pathC(t, e) {
              var { pathParser: r } = this,
                { current: i, point: n, controlPoint: s, currentPoint: a } = pt.pathC(r)
              r.addMarker(a, s, n),
            ...
            pathS(t, e) {
              var { pathParser: r } = this,
                { current: i, point: n, controlPoint: s, currentPoint: a } = pt.pathS(r)
              r.addMarker(a, s, n),
                e.addBezierCurve(i.x, i.y, n.x, n.y, s.x, s.y, a.x, a.y),
                t && t.bezierCurveTo(n.x, n.y, s.x, s.y, a.x, a.y)
            }
            static pathQ(t) {
              var { current: e } = t
              return { current: e, controlPoint: t.getAsControlPoint('x1', 'y1'), currentPoint: t.getAsCurrentPoint() }
            }
            pathQ(t, e) {
              var { pathParser: r } = this,
                { current: i, controlPoint: n, currentPoint: s } = pt.pathQ(r)
              r.addMarker(s, n, n),
            ...
            pathT(t, e) {
              var { pathParser: r } = this,
                { current: i, controlPoint: n, currentPoint: s } = pt.pathT(r)
              r.addMarker(s, n, n),
                e.addQuadraticCurve(i.x, i.y, n.x, n.y, s.x, s.y),
                t && t.quadraticCurveTo(n.x, n.y, s.x, s.y)
            }
            static pathA(t) {
              ...
              isNaN(g) && (g = 0)
              var d = new Y((g * i * l.y) / n, (g * -n * l.x) / i),
                f = new Y(
                  (e.x + u.x) / 2 + Math.cos(h) * d.x - Math.sin(h) * d.y,
                  (e.y + u.y) / 2 + Math.sin(h) * d.x + Math.cos(h) * d.y
                ),
                p = R([1, 0], [(l.x - d.x) / i, (l.y - d.y) / n]),
                y = [(l.x - d.x) / i, (l.y - d.y) / n],
                m = [(-l.x - d.x) / i, (-l.y - d.y) / n],
                v = R(y, m)
              return (
                k(y, m) <= -1 && (v = Math.PI),
                k(y, m) >= 1 && (v = 0),
                { currentPoint: u, rX: i, rY: n, sweepFlag: o, xAxisRotation: h, centp: f, a1: p, ad: v }
              )
            }
            pathA(t, e) {
              var { pathParser: r } = this,
                { currentPoint: i, rX: n, rY: s, sweepFlag: a, xAxisRotation: o, centp: h, a1: u, ad: l } = pt.pathA(r),
                c = 1 - a ? 1 : -1,
                g = u + c * (l / 2),
                d = new Y(h.x + n * Math.cos(g), h.y + s * Math.sin(g))
              if (
            ...
            pathZ(t, e) {
              pt.pathZ(this.pathParser), t && e.x1 !== e.x2 && e.y1 !== e.y2 && t.closePath()
            }
          }
          class yt extends pt {
            constructor(t, e, r) {
          ...
          class mt extends ft {
            ...
            getFontSize() {
              var { document: t, parent: e } = this,
                r = ct.parse(t.ctx.font).fontSize
              return e.getStyle('font-size').getNumber(r)
            }
            getTElementBoundingBox(t) {
              var e = this.getFontSize()
              return new gt(this.x, this.y - e, this.x + this.measureText(t), this.y)
            }
            getGlyph(t, e, r) {
              var i = e[r],
                n = null
              ...
              if (n)
                for (
                  ...
                  ;(t.lineWidth = (t.lineWidth * s) / o),
                    ...
                    void 0 === c[d] || isNaN(c[d]) || (this.x += c[d])
                }
              else {
                var { x: y, y: v } = this
            ...
            adjustChildCoordinates(t, e, r, i) {
              ...
              return (
                l && (e.x -= c),
                s.hasValue()
                  ? (e.applyAnchoring(), (n.x = s.getPixels('x')), o.hasValue() && (n.x += o.getPixels('x')))
              ...
              if (i) {
                for (
                  var n = this.getFontSize(),
                    ...
                    a = m(r.getAttribute('dx').getString()),
                    o = s.length,
                    h = 0,
                    u = 0;
                  u < o;
                  ...
                  ;(h += ((this.getGlyph(i, s, u).horizAdvX || i.horizAdvX) * n) / i.fontFace.unitsPerEm),
                    void 0 === a[u] || isNaN(a[u]) || (h += a[u])
                }
                return h
              }
            ...
            getInheritedAttribute(t) {
              for (var e = this; e instanceof mt && e.isFirstChild(); ) {
          ...
          class bt extends ft {
            ...
            setContext(t) {
              ...
              if ((i.setDefaults(t), s.style && void 0 !== t.font && n && void 0 !== n.getComputedStyle)) {
                ...
                var a = new U(r, 'fontSize', ct.parse(t.font).fontSize)
              ...
              var u = this.getAttribute('refX'),
                ...
                g = c.hasValue() ? m(c.getString()) : null,
              ...
              g && ((f = g[0]), (p = g[1])),
                this.root ||
                  ...
                  'marker' === this.type && ((y = f), (v = p), (f = 0), (p = 0))),
                i.viewPort.setCurrent(o, h),
                !this.node ||
                  (this.parent &&
                    'foreignObject' !== (null === (e = this.node.parentNode) || void 0 === e ? void 0 : e.nodeName)) ||
              ...
              if (
                ...
                t.beginPath(),
                  n > 0 &&
                    ...
                    t.lineTo(e + i, r + n - h),
                    t.bezierCurveTo(e + i, r + n - h + u * h, e + i - o + u * o, r + n, e + i - o, r + n),
                    t.lineTo(e + o, r + n),
          ...
          class At extends pt {
            ...
            getPoints() {
              return [
                new Y(this.getAttribute('x1').getPixels('x'), this.getAttribute('y1').getPixels('y')),
                new Y(this.getAttribute('x2').getPixels('x'), this.getAttribute('y2').getPixels('y'))
              ]
            }
            path(t) {
              var [{ x: e, y: r }, { x: i, y: n }] = this.getPoints()
              return t && (t.beginPath(), t.moveTo(e, r), t.lineTo(i, n)), new gt(e, r, i, n)
            }
            getMarkers() {
          ...
          class Ot extends at {
            ...
            createPattern(t, e, r) {
              var i = this.getStyle('width').getPixels('x', !0),
                ...
                s = new bt(this.document, null)
              ;(s.attributes.viewBox = new U(this.document, 'viewBox', this.getAttribute('viewBox').getValue())),
                (s.attributes.width = new U(this.document, 'width', ''.concat(i, 'px'))),
                (s.attributes.height = new U(this.document, 'height', ''.concat(n, 'px'))),
                (s.attributes.transform = new U(
                  this.document,
                  'transform',
              ...
              for (var l = -1; l <= 1; l++)
                for (var c = -1; c <= 1; c++)
                  o.save(),
                    (s.attributes.x = new U(this.document, 'x', l * a.width)),
                    (s.attributes.y = new U(this.document, 'y', c * a.height)),
                    s.render(o),
                    o.restore()
            ...
            render(t, e, r) {
              if (e) {
                ...
                t.translate(i, n),
                  ...
                  t.save()
                var o = new bt(this.document, null)
                ;(o.type = this.type),
                  (o.attributes.viewBox = new U(this.document, 'viewBox', this.getAttribute('viewBox').getValue())),
                  (o.attributes.refX = new U(this.document, 'refX', this.getAttribute('refX').getValue())),
                  (o.attributes.refY = new U(this.document, 'refY', this.getAttribute('refY').getValue())),
                  (o.attributes.width = new U(this.document, 'width', this.getAttribute('markerWidth').getValue())),
                  (o.attributes.height = new U(this.document, 'height', this.getAttribute('markerHeight').getValue())),
                  (o.attributes.overflow = new U(this.document, 'overflow', this.getAttribute('overflow').getValue())),
                  (o.attributes.fill = new U(this.document, 'fill', this.getAttribute('fill').getColor('black'))),
                  (o.attributes.stroke = new U(this.document, 'stroke', this.getAttribute('stroke').getValue('none'))),
          ...
          class Vt extends at {
            ...
            createGradient(t, e, r) {
              ...
              if (
                ...
                var { document: a } = this,
                  ...
                  [u] = h.viewPorts,
                  l = new St(a, null)
                ;(l.attributes.x = new U(a, 'x', -o / 3)),
                  (l.attributes.y = new U(a, 'y', -o / 3)),
                  (l.attributes.width = new U(a, 'width', o)),
                  (l.attributes.height = new U(a, 'height', o))
                var c = new Nt(a, null)
                ;(c.attributes.transform = new U(a, 'transform', this.getAttribute('gradientTransform').getValue())),
                  (c.children = [l])
                var g = new bt(a, null)
                ;(g.attributes.x = new U(a, 'x', 0)),
                  (g.attributes.y = new U(a, 'y', 0)),
                  (g.attributes.width = new U(a, 'width', u.width)),
                  (g.attributes.height = new U(a, 'height', u.height)),
                  (g.children = [c])
                var d = a.createCanvas(u.width, u.height),
                  f = d.getContext('2d')
                return (f.fillStyle = s), g.render(f), f.createPattern(d, 'no-repeat')
              }
              return s
            }
            ...
            addParentOpacity(t, e) {
              return t.hasValue() ? new U(this.document, 'color', e).addOpacity(t).getColor() : e
            }
          }
          class _t extends Vt {
            constructor(t, e, r) {
          ...
          class kt extends Vt {
            ...
            getGradient(t, e) {
              ...
              this.getAttribute('fx').hasValue() &&
                (a = r ? i.x + i.width * this.getAttribute('fx').getNumber() : this.getAttribute('fx').getPixels('x')),
          ...
          class It extends at {
            constructor(t, e, r) {
              super(t, e, r),
                ...
                (this.values = new U(t, 'values', null))
            ...
            update(t) {
              var { parent: e } = this,
                r = this.getProperty()
              if (
                (this.initialValue || ((this.initialValue = r.getString()), (this.initialUnits = r.getUnits())),
            ...
            getProgress() {
              ...
              if (e.hasValue()) {
                var i = r.progress * (e.getValue().length - 1),
                  n = Math.floor(i),
                  s = Math.ceil(i)
                ;(r.from = new U(t, 'from', parseFloat(e.getValue()[n]))),
                  (r.to = new U(t, 'to', parseFloat(e.getValue()[s]))),
                  (r.progress = (i - n) / (s - n))
          ...
          class Lt extends It {
            ...
            calcValue() {
              var { progress: t, from: e, to: r } = this.getProgress(),
                i = new l.a(e.getColor()),
                n = new l.a(r.getColor())
              if (i.ok && n.ok) {
                var s = i.r + (n.r - i.r) * t,
                  a = i.g + (n.g - i.g) * t,
                  o = i.b + (n.b - i.b) * t
                ...
                switch (s.type) {
                  ...
                  case 'glyph':
                    ...
                    o.arabicForm
                      ? ((this.isRTL = !0),
                        (this.isArabic = !0),
                        void 0 === this.glyphs[o.unicode] && (this.glyphs[o.unicode] = {}),
            ...
            renderChildren(t) {
              if (this.hasText) {
                ...
                var { document: e, x: r, y: i } = this,
                  { mouse: n } = e.screen,
                  s = new U(e, 'fontSize', ct.parse(e.ctx.font).fontSize)
                n.isWorking() && n.checkBoundingBox(this, new gt(r, i - s.getPixels('y'), r + this.measureText(t), i))
          ...
          class jt extends mt {
              ...
              'underline' === e && t.beginPath(),
                i.forEach((i, n) => {
                  ...
                  t.save(),
                    ...
                    t.restore(),
                    'underline' === e && (0 === n && t.moveTo(s.x, s.y + r / 8), t.lineTo(a.x, a.y + r / 5))
                }),
                'underline' === e && ((t.lineWidth = r / 20), (t.strokeStyle = n), t.stroke(), t.closePath()),
                t.restore()
            }
            getLetterSpacingAt() {
            ...
            findSegmentToFitChar(t, e, r, i, n, s, a, o, h) {
              ...
              var c = this.textHeight / 20,
                ...
                d = this.getEquidistantPointOnPath(u + l, c, 0),
                f = { p0: g, p1: d },
                p = g && d ? Math.atan2(d.y - g.y, d.x - g.x) : 0
              if (a) {
                var y = Math.cos(Math.PI / 2 + p) * a,
                  m = Math.cos(-p) * a
                ;(f.p0 = Yt(Yt({}, g), {}, { x: g.x + y, y: g.y + m })),
                  (f.p1 = Yt(Yt({}, d), {}, { x: d.x + y, y: d.y + m }))
              }
              return { offset: (u += l), segment: f, rotation: p }
            }
            measureText(t, e) {
            ...
            setTextData(t) {
              if (!this.glyphInfo) {
                ...
                o.hasValue() && 'inherit' !== o.getValue()
                  ? o.hasValue() && 'initial' !== o.getValue() && 'unset' !== o.getValue() && (u = o.getPixels())
                  : (u = h.getPixels())
                var l = [],
                  c = e.length
                this.letterSpacingCache = l
                for (var g = 0; g < c; g++) l.push(void 0 !== n[g] ? n[g] : u)
                var d = l.reduce((t, e, r) => (0 === r ? 0 : t + e || 0), 0),
                ...
                var y = this.getPathLength(),
                  ...
                  v = 0
                ;('middle' !== a && 'center' !== a) || (v = -p / 2),
                  ('end' !== a && 'right' !== a) || (v = -p),
                  (v += m),
                  r.forEach((e, n) => {
                    var { offset: o, segment: h, rotation: u } = this.findSegmentToFitChar(t, a, p, y, i, v, s, e, n)
                    ;(v = o), h.p0 && h.p1 && this.glyphInfo.push({ text: r[n], p0: h.p0, p1: h.p1, rotation: u })
                  })
              }
            }
            parsePathData(t) {
              ...
              for (r.reset(); !r.isEnd(); ) {
                ...
                a.type !== dt.CLOSE_PATH
                  ? e.push({ type: o, points: h, start: { x: n, y: s }, pathLength: this.calcLength(n, s, o, h) })
                  : e.push({ type: dt.CLOSE_PATH, points: [], pathLength: 0 })
              }
              return e
            }
            pathM(t, e) {
              var { x: r, y: i } = pt.pathM(t).point
              e.push(r, i)
            }
            pathL(t, e) {
              var { x: r, y: i } = pt.pathL(t).point
              return e.push(r, i), dt.LINE_TO
            }
            pathH(t, e) {
              var { x: r, y: i } = pt.pathH(t).point
              return e.push(r, i), dt.LINE_TO
            }
            pathV(t, e) {
              var { x: r, y: i } = pt.pathV(t).point
              return e.push(r, i), dt.LINE_TO
            }
            pathC(t, e) {
              var { point: r, controlPoint: i, currentPoint: n } = pt.pathC(t)
              e.push(r.x, r.y, i.x, i.y, n.x, n.y)
            }
            pathS(t, e) {
              var { point: r, controlPoint: i, currentPoint: n } = pt.pathS(t)
              return e.push(r.x, r.y, i.x, i.y, n.x, n.y), dt.CURVE_TO
            }
            pathQ(t, e) {
              var { controlPoint: r, currentPoint: i } = pt.pathQ(t)
              e.push(r.x, r.y, i.x, i.y)
            }
            pathT(t, e) {
              var { controlPoint: r, currentPoint: i } = pt.pathT(t)
              return e.push(r.x, r.y, i.x, i.y), dt.QUAD_TO
            }
            pathA(t) {
              var { rX: e, rY: r, sweepFlag: i, xAxisRotation: n, centp: s, a1: a, ad: o } = pt.pathA(t)
              return (
                0 === i && o > 0 && (o -= 2 * Math.PI),
                1 === i && o < 0 && (o += 2 * Math.PI),
                [s.x, s.y, e, r, a, o, n, i]
            ...
            calcLength(t, e, r, i) {
              ...
              switch (r) {
                ...
                case dt.CURVE_TO:
                  for (
                    n = 0, s = this.getPointOnCubicBezier(0, t, e, i[0], i[1], i[2], i[3], i[4], i[5]), o = 0.01;
                    o <= 1;
                    o += 0.01
                  )
                ...
                case dt.QUAD_TO:
                  for (
                    n = 0, s = this.getPointOnQuadraticBezier(0, t, e, i[0], i[1], i[2], i[3]), o = 0.01;
                    o <= 1;
                    o += 0.01
                  )
            ...
            getPointOnLine(t, e, r, i, n) {
              ...
              var u = o * h,
                l = null
              if (i === e) l = { x: s, y: a + u }
              else if ((a - r) / (s - e + V) === o) l = { x: s + h, y: a + u }
              else {
                var c,
                  g,
                ...
                ;(c = e + (f /= d * d) * (i - e)), (g = r + f * (n - r))
                var p = this.getLineLength(s, a, c, g),
                  y = Math.sqrt(t * t - p * p)
                ;(h = Math.sqrt((y * y) / (1 + o * o))), i < e && (h *= -1), (l = { x: c + h, y: g + (u = o * h) })
              }
              return l
            }
            getPointOnPath(t) {
                  ...
                  switch (s.type) {
                    ...
                    case dt.ARC:
                      var h = s.points[4],
                        u = s.points[5],
                        l = s.points[4] + u
                      if (((o = h + (a / s.pathLength) * u), (u < 0 && o < l) || (u >= 0 && o > l))) break
            ...
            getPathLength() {
              return (
                -1 === this.pathLength &&
                  (this.pathLength = this.dataArray.reduce((t, e) => (e.pathLength > 0 ? t + e.pathLength : t), 0)),
                this.pathLength
              )
            }
            getPointOnCubicBezier(t, e, r, i, n, s, a, o, h) {
              return { x: o * I(t) + s * L(t) + i * D(t) + e * B(t), y: h * I(t) + a * L(t) + n * D(t) + r * B(t) }
            }
            getPointOnQuadraticBezier(t, e, r, i, n, s, a) {
              return { x: s * z(t) + i * H(t) + e * F(t), y: a * z(t) + n * H(t) + r * F(t) }
            }
          ...
          class Zt extends ft {
            ...
            renderChildren(t) {
              ...
              if (r) {
                ...
                if (
                  ('symbol' === r.type &&
                    (((i = new bt(e, null)).attributes.viewBox = new U(
                      e,
                      'viewBox',
                      r.getAttribute('viewBox').getString()
                    )),
                    (i.attributes.preserveAspectRatio = new U(
                      e,
                      'preserveAspectRatio',
                      r.getAttribute('preserveAspectRatio').getString()
                    )),
                    (i.attributes.overflow = new U(e, 'overflow', r.getAttribute('overflow').getString())),
                    (i.children = r.children),
                    (r.styles.opacity = new U(e, 'opacity', this.calculateOpacity()))),
                  'svg' === i.type)
                ) {
                  var n = this.getStyle('width', !1, !0),
                    s = this.getStyle('height', !1, !0)
                  n.hasValue() && (i.attributes.width = new U(e, 'width', n.getString())),
                    s.hasValue() && (i.attributes.height = new U(e, 'height', s.getString()))
                }
                var a = i.parent
            ...
            elementTransform() {
              ...
              return st.fromElement(t, e)
            }
            get element() {
              return (
                this.cachedElement || (this.cachedElement = this.getHrefAttribute().getDefinition()), this.cachedElement
              )
            }
          }
          function Jt(t, e, r, i, n, s) {
            return t[r * i * 4 + 4 * e + s]
          }
          function Kt(t, e, r, i, n, s, a) {
            t[r * i * 4 + 4 * e + s] = a
          }
          function te(t, e, r) {
            return t[e] * r
          ...
          class re extends at {
            constructor(t, e, r) {
              ...
              var i = m(this.getAttribute('values').getString())
              switch (this.getAttribute('type').getString('matrix')) {
                ...
                case 'hueRotate':
                  ...
                  i = [
                    ee(s, 0.213, 0.787, -0.213),
                    ee(s, 0.715, -0.715, -0.715),
                    ee(s, 0.072, -0.072, 0.928),
                    0,
                    0,
                    ee(s, 0.213, -0.213, 0.143),
                    ee(s, 0.715, 0.285, 0.14),
                    ee(s, 0.072, -0.072, -0.283),
                    0,
                    0,
                    ee(s, 0.213, -0.213, -0.787),
                    ee(s, 0.715, -0.715, 0.715),
                    ee(s, 0.072, 0.928, 0.072),
                    0,
                    0,
                    0,
                    0,
            ...
            apply(t, e, r, i, n) {
              for (var { includeOpacity: s, matrix: a } = this, o = t.getImageData(0, 0, i, n), h = 0; h < n; h++)
                for (var u = 0; u < i; u++) {
                  var l = Jt(o.data, u, h, i, 0, 0),
                    c = Jt(o.data, u, h, i, 0, 1),
                    g = Jt(o.data, u, h, i, 0, 2),
                    d = Jt(o.data, u, h, i, 0, 3),
                    f = te(a, 0, l) + te(a, 1, c) + te(a, 2, g) + te(a, 3, d) + te(a, 4, 1),
                    p = te(a, 5, l) + te(a, 6, c) + te(a, 7, g) + te(a, 8, d) + te(a, 9, 1),
                    y = te(a, 10, l) + te(a, 11, c) + te(a, 12, g) + te(a, 13, d) + te(a, 14, 1),
                    m = te(a, 15, l) + te(a, 16, c) + te(a, 17, g) + te(a, 18, d) + te(a, 19, 1)
                  s && ((f = 0), (p = 0), (y = 0), (m *= d / 255)),
                    Kt(o.data, u, h, i, 0, 0, f),
                    Kt(o.data, u, h, i, 0, 1, p),
                    Kt(o.data, u, h, i, 0, 2, y),
                    Kt(o.data, u, h, i, 0, 3, m)
                }
          ...
          class ie extends at {
            ...
            apply(t, e) {
              ...
              var h = this.removeStyles(e, ie.ignoreStyles),
              ...
              if (n) {
                ...
                if (!(u < 1 || l < 1)) {
                  var c = Math.floor(n.x),
                    g = Math.floor(n.y),
                    d = this.removeStyles(e, ae.ignoreStyles),
                  ...
                  r.screen.setDefaults(p),
                    ...
                    e.render(p),
                    i.forEach(t => {
                      'function' == typeof t.apply && t.apply(p, 0, 0, u, l)
                    }),
          ...
          ae.ignoreStyles = ['filter', 'transform', 'clip-path']
          class oe extends at {
            constructor(t, e, r) {
          ...
          class ye {
            constructor(t) {
              var {
                rootEmSize: e = 12,
                emSize: r = 12,
                createCanvas: i = ye.createCanvas,
                createImage: n = ye.createImage,
            ...
            createElement(t) {
              var e = t.nodeName.replace(/^[^:]+:/, ''),
                r = ye.elementTypes[e]
              return void 0 !== r ? new r(this, t) : new ot(this, t)
            }
            createTextNode(t) {
          ...
          ;(ye.createCanvas = function (t, e) {
            var r = document.createElement('canvas')
            return (r.width = t), (r.height = e), r
          }),
            (ye.createImage = function (t) {
          ...
          class xe {
            constructor(t, e) {
              var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}
              ;(this.parser = new Z(r)), (this.screen = new W(t, r)), (this.options = r)
              var i = new ye(this, r),
            ...
            static fromString(t, e) {
              var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
                i = new Z(r).parseFromString(e)
              return new xe(t, i, r)
            }
            fork(t, e) {
              var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}
              return xe.from(t, e, ve(ve({}, this.options), r))
            }
            forkString(t, e) {
              var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}
              return xe.fromString(t, e, ve(ve({}, this.options), r))
            }
            ready() {
            ...
            render() {
              ...
              return n()(function* () {
                ...
                e.start(ve({ enableRedraw: !0, ignoreAnimation: !0, ignoreMouse: !0 }, r)), yield e.ready(), e.stop()
              })()
            }
            start() {
              var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                { documentElement: e, screen: r, options: i } = this
              r.start(e, ve(ve({ enableRedraw: !0 }, i), t))
            }
            stop() {
              this.screen.stop()
            }
    ...
    801: function (t, e, r) {
      ;(function (e) {
        for (
          ...
          (o = n[s[u] + 'Request' + a]), (h = n[s[u] + 'Cancel' + a] || n[s[u] + 'CancelRequest' + a])
        if (!o || !h) {
          var l = 0,
            c = 0,
            g = []
          ...
          (this.getHelpXML = function () {
            ...
            for (i = 0; i < t.length; i++)
              try {
                ...
                ;(l.style.cssText =
                  'margin: 3px; border: 1px solid black; background:' + u.toHex() + '; color:' + u.toHex()),
...
***************************************************************************** */
      ...
      function h(t, e, r) {
        ...
        var u = s([(e - a) / 2, (r - h) / 2], (-t.xRot / 180) * o),
          l = u[0],
          c = u[1],
          g = Math.pow(l, 2) / Math.pow(i, 2) + Math.pow(c, 2) / Math.pow(n, 2)
        1 < g && ((i *= Math.sqrt(g)), (n *= Math.sqrt(g))), (t.rX = i), (t.rY = n)
        var d = Math.pow(i, 2) * Math.pow(c, 2) + Math.pow(n, 2) * Math.pow(l, 2),
          f = (t.lArcFlag !== t.sweepFlag ? 1 : -1) * Math.sqrt(Math.max(0, (Math.pow(i, 2) * Math.pow(n, 2) - d) / d)),
          p = ((i * c) / n) * f,
          y = ((-n * l) / i) * f,
          m = s([p, y], (t.xRot / 180) * o)
        ;(t.cX = m[0] + (e + a) / 2),
          (t.cY = m[1] + (r + h) / 2),
          (t.phi1 = Math.atan2((c - y) / n, (l - p) / i)),
          (t.phi2 = Math.atan2((-c - y) / n, (-l - p) / i)),
          0 === t.sweepFlag && t.phi2 > t.phi1 && (t.phi2 -= 2 * o),
          1 === t.sweepFlag && t.phi2 < t.phi1 && (t.phi2 += 2 * o),
          (t.phi1 *= 180 / o),
          (t.phi2 *= 180 / o)
      }
      function u(t, e, r) {
      ...
      function d(t, e, r, i) {
        return t + Math.cos((i / 180) * o) * e + Math.sin((i / 180) * o) * r
      }
      function f(t, e, r, i) {
        var n = 1e-6,
          s = e - t,
      ...
      !(function (t) {
        ...
        function n(t) {
          var e = 0,
            ...
            n = NaN
          return function (s) {
            if (isNaN(i) && !(s.type & S.MOVE_TO)) throw new Error('path must start with moveto')
            var a = t(s, e, r, i, n)
            return (
              s.type & S.CLOSE_PATH && ((e = i), (r = n)),
              void 0 !== s.x && (e = s.relative ? e + s.x : s.x),
              void 0 !== s.y && (r = s.relative ? r + s.y : s.y),
              s.type & S.MOVE_TO && ((i = e), (n = r)),
              a
            )
          }
        }
          ...
          return (
            ...
            n(function (n, a, h, u) {
              var l = n.x1,
                ...
                d = void 0 !== n.x ? n.x : g ? 0 : a,
                f = void 0 !== n.y ? n.y : g ? 0 : h
              function p(t) {
                return t * t
              }
              n.type & S.HORIZ_LINE_TO && 0 !== e && ((n.type = S.LINE_TO), (n.y = n.relative ? 0 : h)),
                n.type & S.VERT_LINE_TO && 0 !== r && ((n.type = S.LINE_TO), (n.x = n.relative ? 0 : a)),
                void 0 !== n.x && (n.x = n.x * t + f * r + (g ? 0 : s)),
                void 0 !== n.y && (n.y = d * e + n.y * i + (g ? 0 : o)),
                void 0 !== n.x1 && (n.x1 = n.x1 * t + n.y1 * r + (g ? 0 : s)),
                void 0 !== n.y1 && (n.y1 = l * e + n.y1 * i + (g ? 0 : o)),
                void 0 !== n.x2 && (n.x2 = n.x2 * t + n.y2 * r + (g ? 0 : s)),
                void 0 !== n.y2 && (n.y2 = c * e + n.y2 * i + (g ? 0 : o))
              var y = t * i - e * r
              if (void 0 !== n.xRot && (1 !== t || 0 !== e || 0 !== r || 1 !== i))
                if (0 === y)
                  delete n.rX, delete n.rY, delete n.xRot, delete n.lArcFlag, delete n.sweepFlag, (n.type = S.LINE_TO)
                else {
                  var m = (n.xRot * Math.PI) / 180,
                    ...
                    C = p(v) * b + p(x) * w,
                    P = T * i * i - A * e * i + C * e * e,
                    O = A * (t * i + e * r) - 2 * (T * r * i + C * t * e),
                    E = T * r * r - A * t * r + C * t * t,
                    M = ((Math.atan2(O, P - E) + Math.PI) % Math.PI) / 2,
                    N = Math.sin(M),
                    V = Math.cos(M)
                  ;(n.rX = Math.abs(y) / Math.sqrt(P * p(V) + O * N * V + E * p(N))),
                    (n.rY = Math.abs(y) / Math.sqrt(P * p(N) - O * N * V + E * p(V))),
        ...
        ;(t.ROUND = function (t) {
          ...
          (t.NORMALIZE_HVZ = function (t, e, r) {
            return (
              ...
              n(function (i, n, s, a, o) {
                if (isNaN(a) && !(i.type & S.MOVE_TO)) throw new Error('path must start with moveto')
                return (
                  e && i.type & S.HORIZ_LINE_TO && ((i.type = S.LINE_TO), (i.y = i.relative ? 0 : s)),
                  r && i.type & S.VERT_LINE_TO && ((i.type = S.LINE_TO), (i.x = i.relative ? 0 : n)),
                  t &&
                    i.type & S.CLOSE_PATH &&
                    ((i.type = S.LINE_TO), (i.x = i.relative ? a - n : a), (i.y = i.relative ? o - s : o)),
                  i.type & S.ARC &&
                    (0 === i.rX || 0 === i.rY) &&
                    ((i.type = S.LINE_TO),
                    delete i.rX,
          ...
          (t.SANITIZE = function (t) {
            ...
            return n(function (n, a, o, h, u) {
              var l = Math.abs,
                ...
                d = 0
              if (
                (n.type & S.SMOOTH_CURVE_TO && ((g = isNaN(e) ? 0 : a - e), (d = isNaN(r) ? 0 : o - r)),
                n.type & (S.CURVE_TO | S.SMOOTH_CURVE_TO)
                ...
                n.type & S.SMOOTH_QUAD_TO
                  ...
                  : ((i = NaN), (s = NaN)),
                n.type & S.LINE_COMMANDS ||
                  (n.type & S.ARC && (0 === n.rX || 0 === n.rY || !n.lArcFlag)) ||
                  n.type & S.CURVE_TO ||
                  n.type & S.SMOOTH_CURVE_TO ||
                  n.type & S.QUAD_TO ||
                  n.type & S.SMOOTH_QUAD_TO)
                ...
                var f = void 0 === n.x ? 0 : n.relative ? n.x : n.x - a,
                  p = void 0 === n.y ? 0 : n.relative ? n.y : n.y - o
                ...
                l(f) <= t && l(p) <= t && l(g) <= t && l(d) <= t && l(y) <= t && l(m) <= t && (c = !0)
              }
              return n.type & S.CLOSE_PATH && l(a - h) <= t && l(o - u) <= t && (c = !0), c ? [] : n
            })
          }),
          (t.MATRIX = o),
          (t.ROTATE = function (t, e, r) {
            ...
            var i = Math.sin(t),
              n = Math.cos(t)
            return o(n, i, -i, n, e - e * n + r * i, r - e * i - r * n)
          }),
          (t.TRANSLATE = function (t, e) {
            return void 0 === e && (e = 0), a(t, e), o(1, 0, 0, 1, t, e)
          }),
          (t.SCALE = function (t, e) {
            return void 0 === e && (e = t), a(t, e), o(t, 0, 0, e, 0, 0)
          }),
          (t.SKEW_X = function (t) {
              ...
              return S.ARC === t.type
                ? (function (t, e, r) {
                    ...
                    for (
                      ...
                      var v = g(t.phi1, t.phi2, m / d),
                        x = g(t.phi1, t.phi2, (m + 1) / d),
                        b = x - v,
                        w = (4 / 3) * Math.tan((b * c) / 4),
                        T = [Math.cos(v * c) - w * Math.sin(v * c), Math.sin(v * c) + w * Math.cos(v * c)],
                        A = T[0],
                        C = T[1],
                        P = [Math.cos(x * c), Math.sin(x * c)],
                        O = P[0],
                        E = P[1],
                        M = [O + w * Math.sin(x * c), E - w * Math.cos(x * c)],
                        N = M[0],
                        V = M[1]
                      f[m] = { relative: t.relative, type: S.CURVE_TO }
                      var _ = function (e, r) {
                        var i = s([e * t.rX, r * t.rY], t.xRot),
                          n = i[0],
                          a = i[1]
          ...
          (t.ANNOTATE_ARCS = function () {
            return n(function (t, e, r) {
              return t.relative && ((e = 0), (r = 0)), S.ARC === t.type && h(t, e, r), t
            })
          }),
          (t.CLONE = function () {
            return function (t) {
          ...
          (t.CALCULATE_BOUNDS = function () {
            var t = e(),
              ...
              o = n(function (e, r, i) {
                ...
                if (
                  (n.type & S.DRAWING_COMMANDS && (l(r), c(i)),
                  n.type & S.HORIZ_LINE_TO && l(n.x),
                  n.type & S.VERT_LINE_TO && c(n.y),
                  n.type & S.LINE_TO && (l(n.x), c(n.y)),
                  n.type & S.CURVE_TO)
                ) {
                  l(n.x), c(n.y)
                  for (var g = 0, y = f(r, n.x1, n.x2, n.x); g < y.length; g++)
                    0 < (k = y[g]) && 1 > k && l(p(r, n.x1, n.x2, n.x, k))
                  for (var m = 0, v = f(i, n.y1, n.y2, n.y); m < v.length; m++)
                    0 < (k = v[m]) && 1 > k && c(p(i, n.y1, n.y2, n.y, k))
                }
                if (n.type & S.ARC) {
                  l(n.x), c(n.y), h(n, r, i)
                  for (
                    var x = (n.xRot / 180) * Math.PI,
                      b = Math.cos(x) * n.rX,
                      w = Math.sin(x) * n.rX,
                      T = -Math.sin(x) * n.rY,
                      A = Math.cos(x) * n.rY,
                    ...
                    (k = N[M]) > P && k < O && l(d(n.cX, b, T, k))
                  for (var V = 0, _ = u(A, -w, 0).map(E); V < _.length; V++) {
                    var k
                    ;(k = _[V]) > P && k < O && c(d(n.cY, w, A, k))
                  }
                }
                return e
              })
      ...
      var y,
        m = (function () {
          ...
          return (
            ...
            (t.prototype.matrix = function (t, e, r, i, n, s) {
              return this.transform(l.MATRIX(t, e, r, i, n, s))
            }),
                        ...
                        if (this.curNumber && -1 !== this.curCommandType) {
                          ...
                          if (this.curCommandType === S.ARC)
                            if (0 === this.curArgs.length || 1 === this.curArgs.length) {
                              if (0 > h)
                                throw new SyntaxError('Expected positive number, got "' + h + '" at index "' + n + '"')
                            } else if (
                              (3 === this.curArgs.length || 4 === this.curArgs.length) &&
                              '0' !== this.curNumber &&
                              '1' !== this.curNumber
                              ...
                              throw new SyntaxError(
                                'Expected a flag, got "' + this.curNumber + '" at index "' + n + '"'
                              )
                          this.curArgs.push(h),
                            this.curArgs.length === w[this.curCommandType] &&
                              (S.HORIZ_LINE_TO === this.curCommandType
                                ? i({ type: S.HORIZ_LINE_TO, relative: this.curCommandRelative, x: h })
                                : S.VERT_LINE_TO === this.curCommandType
                                ? i({ type: S.VERT_LINE_TO, relative: this.curCommandRelative, y: h })
                                ...
                                ? (i({
                                  ...
                                  S.MOVE_TO === this.curCommandType && (this.curCommandType = S.LINE_TO))
                          ...
                          if (',' === s && this.canParseCommandOrComma) this.canParseCommandOrComma = !1
                            ...
                            if (o) (this.curNumber = s), (this.curNumberHasDecimal = !1)
                              ...
                              if (!this.canParseCommandOrComma)
                                throw new SyntaxError(
                                  'Unexpected character "' + s + '" at index ' + n + '. Command cannot follow comma'
                                )
                              if (((this.canParseCommandOrComma = !1), 'z' !== s && 'Z' !== s))
                                if ('h' === s || 'H' === s)
                                  (this.curCommandType = S.HORIZ_LINE_TO), (this.curCommandRelative = 'h' === s)
                                else if ('v' === s || 'V' === s)
                                  (this.curCommandType = S.VERT_LINE_TO), (this.curCommandRelative = 'v' === s)
                                else if ('m' === s || 'M' === s)
                                  (this.curCommandType = S.MOVE_TO), (this.curCommandRelative = 'm' === s)
                                else if ('l' === s || 'L' === s)
                                  (this.curCommandType = S.LINE_TO), (this.curCommandRelative = 'l' === s)
                                else if ('c' === s || 'C' === s)
                                  (this.curCommandType = S.CURVE_TO), (this.curCommandRelative = 'c' === s)
                                else if ('s' === s || 'S' === s)
                                  (this.curCommandType = S.SMOOTH_CURVE_TO), (this.curCommandRelative = 's' === s)
                                else if ('q' === s || 'Q' === s)
                                  (this.curCommandType = S.QUAD_TO), (this.curCommandRelative = 'q' === s)
                                else if ('t' === s || 'T' === s)
                                  (this.curCommandType = S.SMOOTH_QUAD_TO), (this.curCommandRelative = 't' === s)
                                else {
                                  if ('a' !== s && 'A' !== s)
                                    throw new SyntaxError('Unexpected character "' + s + '" at index ' + n + '.')
                                  ;(this.curCommandType = S.ARC), (this.curCommandRelative = 'a' === s)
                                }
                              else
          ...
          return (
            ...
            (e.encode = function (t) {
              return (function (t) {
                ...
                for (var r = 0; r < t.length; r++) {
                  var i = t[r]
                  if (i.type === S.CLOSE_PATH) e += 'z'
                  else if (i.type === S.HORIZ_LINE_TO) e += (i.relative ? 'h' : 'H') + i.x
                  else if (i.type === S.VERT_LINE_TO) e += (i.relative ? 'v' : 'V') + i.y
                  else if (i.type === S.MOVE_TO) e += (i.relative ? 'm' : 'M') + i.x + ' ' + i.y
                  else if (i.type === S.LINE_TO) e += (i.relative ? 'l' : 'L') + i.x + ' ' + i.y
                  else if (i.type === S.CURVE_TO)
                    e += (i.relative ? 'c' : 'C') + i.x1 + ' ' + i.y1 + ' ' + i.x2 + ' ' + i.y2 + ' ' + i.x + ' ' + i.y
                  else if (i.type === S.SMOOTH_CURVE_TO)
                    e += (i.relative ? 's' : 'S') + i.x2 + ' ' + i.y2 + ' ' + i.x + ' ' + i.y
                  else if (i.type === S.QUAD_TO)
                    e += (i.relative ? 'q' : 'Q') + i.x1 + ' ' + i.y1 + ' ' + i.x + ' ' + i.y
                  else if (i.type === S.SMOOTH_QUAD_TO) e += (i.relative ? 't' : 'T') + i.x + ' ' + i.y
                  else {
                    if (i.type !== S.ARC)
                      throw new Error('Unexpected command type "' + i.type + '" at index ' + r + '.')
                    e +=
                      (i.relative ? 'a' : 'A') +
                      i.rX +
                      ' ' +
        ...
        w =
          ...
          (y[S.CLOSE_PATH] = 0),
          (y[S.QUAD_TO] = 4),
          (y[S.SMOOTH_QUAD_TO] = 2),
          (y[S.CURVE_TO] = 6),
          (y[S.SMOOTH_CURVE_TO] = 4),
          (y[S.ARC] = 7),
          y)
    },
    805: function (t, e, r) {
      ...
      function a(t, e, r, n, s) {
        if (('string' == typeof t && (t = document.getElementById(t)), !t || 'object' !== i(t) || !('getContext' in t)))
          throw new TypeError('Expecting canvas with `getContext` method in processCanvasRGB(A) calls!')
        var a = t.getContext('2d')
        try {
          return a.getImageData(e, r, n, s)
        } catch (t) {
          throw new Error('unable to access image data: ' + t)
        }
      }
      function o(t, e, r, i, o, u) {
        if (!(isNaN(u) || u < 1)) {
          u |= 0
          var l = a(t, e, r, i, o)
          ;(l = (function (t, e, r, i, a, o) {
            for (
              var u,
                l = t.data,
                c = 2 * o + 1,
              ...
              (m = m.next = new h()), v === f && (u = m)
            m.next = y
            for (var x = null, b = null, S = 0, w = 0, T = n[o], A = s[o], C = 0; C < a; C++) {
              m = y
              for (var P = l[w], O = l[w + 1], E = l[w + 2], M = l[w + 3], N = 0; N < f; N++)
                (m.r = P), (m.g = O), (m.b = E), (m.a = M), (m = m.next)
              for (
                var V = 0,
                  _ = 0,
                  k = 0,
              ...
              for (var $ = 0; $ < i; $++) {
                ...
                if (((l[w + 3] = Z), 0 !== Z)) {
                  var J = 255 / Z
                  ;(l[w] = ((z * T) >> A) * J), (l[w + 1] = ((H * T) >> A) * J), (l[w + 2] = ((F * T) >> A) * J)
                } else l[w] = l[w + 1] = l[w + 2] = 0
                ;(z -= I), (H -= L), (F -= D), (U -= B), (I -= x.r), (L -= x.g), (D -= x.b), (B -= x.a)
                var K = $ + o + 1
                ;(K = (S + (K < g ? K : g)) << 2),
                  (V += x.r = l[K]),
                  (_ += x.g = l[K + 1]),
            ...
            for (var st = 0; st < i; st++) {
              var at = l[(w = st << 2)],
                ...
                mt = p * ut
              m = y
              for (var vt = 0; vt < f; vt++) (m.r = at), (m.g = ot), (m.b = ht), (m.a = ut), (m = m.next)
              for (var xt = i, bt = 0, St = 0, wt = 0, Tt = 0, At = 1; At <= o; At++) {
                w = (xt + st) << 2
                var Ct = f - At
                ;(ft += (m.r = at = l[w]) * Ct),
                  (pt += (m.g = ot = l[w + 1]) * Ct),
