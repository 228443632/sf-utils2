    ...
    797: function (e, t, n) {
      ...
      e.exports = (function () {
        ...
        return (function e() {
          ...
          if (((n.version = '2.3.5'), (n.removed = []), !t || !t.document || 9 !== t.document.nodeType))
          ...
          var re = K(X, r),
            ...
            me = {}
          try {
            me = w(o).documentMode ? o.documentMode : {}
          } catch (e) {}
          var fe = {}
          ...
          var de = H,
            ...
            be = j,
            Te = null,
            Ne = E({}, [].concat(q(k), q(S), q(_), q(C), q(M))),
            Ae = null,
            ...
            it = function (e) {
              ;(nt && nt === e) ||
                ...
                (qe = 'ADD_URI_SAFE_ATTR' in e ? E(w(Ye), e.ADD_URI_SAFE_ATTR) : Ye),
                (Pe = 'ADD_DATA_URI_TAGS' in e ? E(w(We), e.ADD_DATA_URI_TAGS) : We),
                (je = 'FORBID_CONTENTS' in e ? E({}, e.FORBID_CONTENTS) : Ge),
                (xe = 'FORBID_TAGS' in e ? E({}, e.FORBID_TAGS) : {}),
                (ke = 'FORBID_ATTR' in e ? E({}, e.FORBID_ATTR) : {}),
                ...
                (Ze = Ze = -1 === Qe.indexOf(e.PARSER_MEDIA_TYPE) ? et : e.PARSER_MEDIA_TYPE),
                (tt =
                ...
                Be &&
                  ((Te = E({}, [].concat(q(M)))),
                  (Ae = []),
                  !0 === Be.html && (E(Te, k), E(Ae, L)),
                  !0 === Be.svg && (E(Te, S), E(Ae, R), E(Ae, F)),
                  !0 === Be.svgFilters && (E(Te, _), E(Ae, R), E(Ae, F)),
                  !0 === Be.mathMl && (E(Te, C), E(Ae, I), E(Ae, F))),
                e.ADD_TAGS && (Te === Ne && (Te = w(Te)), E(Te, e.ADD_TAGS)),
                e.ADD_ATTR && (Ae === Ee && (Ae = w(Ae)), E(Ae, e.ADD_ATTR)),
                e.ADD_URI_SAFE_ATTR && E(qe, e.ADD_URI_SAFE_ATTR),
                e.FORBID_CONTENTS && (je === Ge && (je = w(je)), E(je, e.FORBID_CONTENTS)),
                Ue && (Te['#text'] = !0),
                De && E(Te, ['html', 'head', 'body']),
                Te.table && (E(Te, ['tbody']), delete xe.tbody),
                i && i(e),
                (nt = e))
            },
          ...
          var ut = function (e) {
            ...
            dt = function (e) {
              ...
              return (
                ...
                Xe === Je ? se.call(t, De ? 'html' : 'body')[0] : De ? t.documentElement : a
              )
            },
            pt = function (e) {
              ...
              if (!Te[r] || xe[r]) {
                if (Ue && !je[r]) {
                  var o = te(e) || e.parentNode,
                    i = ee(e) || e.childNodes
                  if (i && o) for (var a = i.length - 1; a >= 0; --a) o.insertBefore(Z(i[a], !0), Q(e))
                }
                if (!xe[r] && Tt(r)) {
                  if (we.tagNameCheck instanceof RegExp && T(we.tagNameCheck, r)) return !1
                  if (we.tagNameCheck instanceof Function && we.tagNameCheck(r)) return !1
                }
                return mt(e), !0
              }
                ...
                if (
                  !(
                    (Tt(e) &&
                      ...
                      ((we.attributeNameCheck instanceof RegExp && T(we.attributeNameCheck, t)) ||
          ...
          return (
            (n.sanitize = function (e, o) {
              var i = void 0,
                ...
                u = void 0,
                m = void 0
              if ((($e = !e) && (e = '\x3c!--\x3e'), 'string' != typeof e && !gt(e))) {
              ...
              if ((Me || it(o), (n.removed = []), 'string' == typeof e && (ze = !1), ze)) {
                if (e.nodeName) {
                  var f = tt(e.nodeName)
                  if (!Te[f] || xe[f]) throw N('root node is forbidden and cannot be sanitized in-place')
                }
              } else if (e instanceof c)
                (1 === (l = (i = dt('\x3c!----\x3e')).ownerDocument.importNode(e, !0)).nodeType &&
                  'BODY' === l.nodeName) ||
                'HTML' === l.nodeName
                  ? (i = l)
                  : i.appendChild(l)
              else {
                if (!Re && !Ce && !De && -1 === e.indexOf('<')) return re && Fe ? re.createHTML(e) : e
              ...
              var p = De ? i.outerHTML : i.innerHTML
              return Ce && ((p = y(p, de, ' ')), (p = y(p, pe, ' '))), re && Fe ? re.createHTML(p) : p
            }),
