                            ...
                            [
                              ...
                              a(
                                'el-button',
                                {
                                  ...
                                  on: {
                                    click: function (s) {
                                      return t.bodyAddClass('theme', s)
                                    }
                                  }
                                },
                                [t._v('给body添加 theme 类')]
                              ),
                              t._v(' '),
                              a(
                                'el-button',
                                {
                                  ...
                                  on: {
                                    click: function (s) {
                                      return t.bodyAddClass('theme-mode', s)
                                    }
                                  }
                                },
                                [t._v('给body添加 theme-mode类')]
                              ),
                              t._v(' '),
                              a(
                                'el-button',
                                {
                                  ...
                                  on: {
                                    click: function (s) {
                                      return t.bodyAddClass('body-class=1 body-class-2', s)
                                    }
                                  }
                                },
                                [t._v('给body添加多个类 body-class=1 body-class-2')]
                              )
                            ],
                            1
                          )
            ...
            return a(
              ...
              [
                a('div', { staticClass: 'custom-block note' }, [
                  ...
                  t._v(' '),
                  a('p', [
                    t._v('给 dom 添加 class，为了兼顾 ie，因为 低版本 ie 不支持 el.classList。 '),
                    a('br'),
                    t._v('\n支持批量添加 class， 空格隔开')
                  ])
                ]),
                          ...
                          a('code', [
                            ...
                            a('span', { pre: !0, attrs: { class: 'token tag' } }, [
                              ...
                              a('span', { pre: !0, attrs: { class: 'token attr-value' } }, [
                                ...
                                t._v('bodyAddClass('),
                                a('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v("'")]),
                                t._v('body-class=1 body-class-2'),
                                a('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v("'")]),
                                t._v(', $event)'),
                                a('span', { pre: !0, attrs: { class: 'token punctuation' } }, [t._v('"')])
                              ]),
                ...
                a('div', { staticClass: 'custom-block warning' }, [
                  ...
                  a('p', [
                    t._v(
                      '当添加多个 class 类时，需要以空格隔开，比如添加两个类，class-1 和 class-2， 这时候传值 class 是'
                    ),
                    a('br'),
                    t._v(' '),
